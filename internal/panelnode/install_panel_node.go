// Package panelnode is a port of src/nginx/install_panel_node.sh
// (538 lines): installs the Remnawave panel AND a co-located selfsteal
// node on the same server, behind Nginx.
package panelnode
