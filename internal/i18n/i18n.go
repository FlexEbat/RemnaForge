...
var english = map[string]string{
	...
	"ASK_WILDCARD_CERT":                   "Was %s's TLS certificate issued as a wildcard covering its base domain, rather than for this exact domain? (y/n):",
	...
	"CADDY_BUILD_NOTE":                    "Building a custom Caddy image with the proxy_protocol module (needed for correct client IPs behind Reality's unix-socket fallback) - this takes a bit longer than pulling a stock image.",
	...
	"ERROR_UPDATE_PROFILE":                    "Failed to update config profile",
	...
	"NODE_PROFILE_PICKER_EMPTY":               "Select at least one inbound.",
	"NODE_PROFILE_PICKER_PROMPT":              "Toggle a number, Enter to confirm:",
	"NODE_PROFILE_PICKER_TITLE":               "Select inbounds for this node:",
	"NODE_PROFILE_RAW":                        "Raw Reality",
	"NODE_PROFILE_UPDATE_FAILED":              "Failed to update the config profile",
	"NODE_PROFILE_UPDATE_SUCCESS":             "Config profile updated successfully",
	"NODE_PROFILE_XHTTP":                      "XHTTP TLS",
...
var russian = map[string]string{
	...
	"ASK_WILDCARD_CERT":                       "TLS-сертификат %s был выпущен как wildcard на базовый домен, а не для этого конкретного домена? (y/n):",
	...
	"CADDY_BUILD_NOTE":                        "Собираем собственный образ Caddy с модулем proxy_protocol (нужен для корректного IP клиента за unix-сокетом фолбэка Reality) - это займёт чуть больше времени, чем обычная загрузка образа.",
	...
	"ERROR_UPDATE_PROFILE":                    "Не удалось обновить конфиг-профиль",
	...
	"NODE_PROFILE_PICKER_EMPTY":               "Выберите хотя бы один inbound.",
	"NODE_PROFILE_PICKER_PROMPT":              "Номер — отметить/снять, Enter — подтвердить:",
	"NODE_PROFILE_PICKER_TITLE":               "Выберите inbound'ы для этой ноды:",
	"NODE_PROFILE_RAW":                        "Raw Reality",
	"NODE_PROFILE_UPDATE_FAILED":              "Не удалось обновить конфиг-профиль",
	"NODE_PROFILE_UPDATE_SUCCESS":             "Конфиг-профиль успешно обновлён",
	"NODE_PROFILE_XHTTP":                      "XHTTP TLS",
	"NOTHING_TEMPLATES":                       "Nothing Sni templates",
